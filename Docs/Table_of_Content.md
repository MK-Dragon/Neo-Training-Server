...
## 1. Aplicação Web (Front-End) – 7 Valores

```
    ✅ a. Registo de login através de ecrã de entrada e, do Facebook ou através do
Google;
    ✅ b. Ao criar a conta, permitir a ativação da mesma, via email;
...
```
i. Gerar automaticamente o horário de completo de determinado
curso, a partir da inserção dos seguintes dados:
...
2. Módulos
    ...
    b. Formadores
    c. Salas
3. Disponibilidade dos formadores
4. Disponibilidade das salas
```
